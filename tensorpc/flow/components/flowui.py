...
class ElkLayoutOptions:
    ...
    defaultBaseNodeModel: Union[Undefined, ElkDefaultBaseNodeModel] = undefined
...
class FlowInternals:
    ...
    def create_sub_flow(
        ...
        for (node_id,
            ...
            if not isinstance(inp_node.data, Undefined):
        ...
        for (node_id,
            ...
            if not isinstance(out_node.data, Undefined):
