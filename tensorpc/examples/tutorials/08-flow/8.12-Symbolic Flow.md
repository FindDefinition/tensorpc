...
```Python 
from tensorpc.flow import mui, three, plus, appctx, mark_create_layout, flowui, mark_did_mount
class App:
    ...
    async def _on_mount(self):
        ...
        nodes, edges, node_type_map = symbolic_flow_bd.build_detached_flow(c_list)
