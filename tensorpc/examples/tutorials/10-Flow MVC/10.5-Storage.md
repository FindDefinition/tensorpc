...
class App:
    ...
    def my_layout(self):
        ...
        nested_node_1 = {
            "n3": NodeModel(type="plain", id="n3", position=flowui.XYPosition(0, 0), label="Nested 1 node 1"),
            "n4": NodeModel(type="plain", id="n4", position=flowui.XYPosition(0, 100), label="Nested 1 node 2"),
        }
        nested_node_0 = {
            "n1": NodeModel(type="plain", id="n1", position=flowui.XYPosition(0, 0), label="Nested 0 node 1"),
    ...
    def add_node(self, data: flowui.PaneContextMenuEvent, target_flow_draft: Any):
        ...
        if node_type == "nested":
            ...
            new_node = NodeModel(type="plain", id=node_id, position=pos, label="Plain")
