...
class App:
    ...
    def my_layout(self):
        ...
        nested_node_0 = {
            ...
            "n2": NodeModel(type="nested", id="n2", position=flowui.XYPosition(0, 100), flow=BasicFlowModel(nodes=nested_node_1, edges={})),
        }
        init_nodes = {
            "n5": NodeModel(type="nested", id="n5", position=flowui.XYPosition(0, 0), flow=BasicFlowModel(nodes=nested_node_0, edges={})),
        }
        ...
        # you can implement your own path-based store or use `AppDraftFileStoreBackend` to store data in app storage.
    ...
    def add_node(self, data: flowui.PaneContextMenuEvent, target_flow_draft: Any):
        ...
        draft = self.dm.get_draft()
        if node_type == "nested":
            new_node = NodeModel(type="nested", id=node_id, position=pos, flow=BasicFlowModel(nodes={}, edges={}))
        else:
