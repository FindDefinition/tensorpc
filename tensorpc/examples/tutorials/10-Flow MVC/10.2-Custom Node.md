...
class App:
    ...
    async def add_node(self, data: flowui.PaneContextMenuEvent):
        ...
        if node_type != "custom":
            new_node = NodeModel(type=node_type, id=node_id, data=flowui.NodeData(label=node_type), position=pos)
        else:
    ...
    def model_to_ui_node(self, node: NodeModel):
        ...
        if node.is_custom_node:
            ...
            node_type_draft = node_draft.type
