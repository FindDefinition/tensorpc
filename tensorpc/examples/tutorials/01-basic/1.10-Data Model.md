        ...
        self.dm = mui.DataModel(model, [
            mui.HBox([
                ...
                mui.VBox([
                    ...
                    mui.MatchCase([
                        mui.MatchCase.Case(True, mui.DataSubQuery("getitem(items, cur)", [mui.HBox([
...
class App:
    ...
    def layout(self):
        ...
        inp.bind_draft_change(self.dm.get_draft().text)
        return mui.VBox([
            self.dm
        ]).prop(height="100%", width="100%")
...
* calculation of query chains is cached, but it will be cleared when you change layout related to data model components.
