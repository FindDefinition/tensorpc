    ...
    def my_layout(self):
        ...
        master_detail = mui.VBox([
            ...
            mui.DataGrid([
                ...
                mui.DataGrid.ColumnDef("idDesp", cell=mui.Markdown("").bind_fields(value="id")),
        ...
        return mui.VBox([
            ...
            dgrid.prop(stickyHeader=False, virtualized=False, size="small", enableGlobalFilter=True),
