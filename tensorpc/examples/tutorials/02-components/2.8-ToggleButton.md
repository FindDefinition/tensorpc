...
class App:
    ...
    def my_layout(self):
        md = mui.Markdown()
        return mui.VBox([
            mui.ToggleButton("value0", name="ToggleButton", callback=lambda x: md.write(f"ToggleButton: :green[{x}]")),
            md,
        ])
...
class App:
    ...
    def my_layout(self):
        return mui.VBox([
            mui.ToggleButton("value0", name="Button"),
            mui.ToggleButton("value1", name="SmallButton").prop(size="small"),
            mui.ToggleButton("value2", name="PrimaryButton").prop(muiColor="primary"),
